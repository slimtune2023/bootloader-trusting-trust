...
int main(int argc, char *argv[]) { 
    ...
    unsigned n_file_bytes;
    uint8_t *file = read_file(&n_file_bytes, filename);

    unsigned file_addr = 0xA000000;
    send_file(fd, file_addr, file, n_file_bytes, filename);
