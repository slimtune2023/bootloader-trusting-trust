...
nrf_t * nrf_init(nrf_t *n, const nrf_conf_t c, uint32_t rxaddr, unsigned acked_p);
nrf_t * staff_nrf_init(const nrf_conf_t c, uint32_t rxaddr, unsigned acked_p);

static inline nrf_t *nrf_init_acked(nrf_t *n, nrf_conf_t c, uint32_t rxaddr) {
    return nrf_init(n, c,rxaddr,1);
}
static inline nrf_t *nrf_init_noack(nrf_t *n, nrf_conf_t c, uint32_t rxaddr) {
    return nrf_init(n, c,rxaddr,0);
}
